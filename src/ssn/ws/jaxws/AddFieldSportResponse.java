...
@XmlRootElement(name = "addFieldSportResponse", namespace = "http://ws.ssn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addFieldSportResponse", namespace = "http://ws.ssn/")

public class AddFieldSportResponse {

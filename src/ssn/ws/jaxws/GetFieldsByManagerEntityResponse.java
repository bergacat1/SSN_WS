...
@XmlRootElement(name = "getFieldsByManagerEntityResponse", namespace = "http://ws.ssn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getFieldsByManagerEntityResponse", namespace = "http://ws.ssn/")

public class GetFieldsByManagerEntityResponse {

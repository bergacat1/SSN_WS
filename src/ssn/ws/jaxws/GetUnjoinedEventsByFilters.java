...
@XmlRootElement(name = "getUnjoinedEventsByFilters", namespace = "http://ws.ssn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getUnjoinedEventsByFilters", namespace = "http://ws.ssn/", propOrder = {"iduser", "idsport", "minplayers", "maxprice", "fromdate", "todate"})

public class GetUnjoinedEventsByFilters {

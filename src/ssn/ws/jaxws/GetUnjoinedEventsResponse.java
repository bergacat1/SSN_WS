...
@XmlRootElement(name = "getUnjoinedEventsResponse", namespace = "http://ws.ssn/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getUnjoinedEventsResponse", namespace = "http://ws.ssn/")

public class GetUnjoinedEventsResponse {
